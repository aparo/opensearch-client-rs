...
impl SslInfo {
    pub fn new(
        ssl_openssl_supports_hostname_validation: bool,
        ssl_openssl_supports_key_manager_factory: bool,
        ssl_provider_transport_server: String,
        ssl_openssl_available: bool,
