...
pub enum TokenType {
  ...
  /// Normalizes width differences in CJK (Chinese, Japanese, and Korean)
  /// characters as follows: Folds full-width ASCII character variants into
  /// the equivalent basic Latin characters Folds half-width Katakana
  /// character variants into the equivalent Kana characters
  Katakana,
