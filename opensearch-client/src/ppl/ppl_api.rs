...
///
    ...
    async fn query(&self, params: QueryParams) -> Result<crate::sql::QueryResponse, Error> {
        ...
        let local_var_uri_str = format!("{}_plugins/_ppl", local_var_configuration.base_path);
    ...
    async fn explain(&self, params: ExplainParams) -> Result<crate::sql::ExplainResponse, Error> {
        ...
        let local_var_uri_str = format!("{}_plugins/_ppl/_explain", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    async fn post_stats(&self, params: PostStatsParams) -> Result<String, Error> {
        ...
        let local_var_uri_str = format!("{}_plugins/_ppl/stats", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
