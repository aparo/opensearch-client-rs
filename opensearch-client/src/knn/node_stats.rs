...
pub struct NodeStats {
    ...
    #[serde(
        rename = "indexing_from_model_degraded",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub indexing_from_model_degraded: Option<bool>,
    #[serde(
        rename = "lucene_initialized",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "script_compilations",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub script_compilations: Option<f64>,
    #[serde(
        rename = "load_exception_count",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub load_exception_count: Option<f64>,
    #[serde(
        rename = "indices_in_cache",
        default,
        skip_serializing_if = "Option::is_none"
    )]
