...
pub struct SearchStats {
    ...
    #[serde(
        rename = "point_in_time_time",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub point_in_time_time: Option<String>,
    ...
    #[serde(
        rename = "concurrent_avg_slice_count",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub concurrent_avg_slice_count: Option<u32>,
    ...
    pub suggest_time_in_millis: String,
    /// The number of open search contexts.
    #[serde(
        rename = "open_contexts",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub open_contexts: Option<u32>,
    /// The total number of shard Point in Time (PIT) contexts created (completed and active) since the node last restarted.
    #[serde(
        rename = "point_in_time_total",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub point_in_time_total: Option<u32>,
    #[serde(
        rename = "search_idle_reactivate_count_total",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub search_idle_reactivate_count_total: Option<u32>,
    /// A duration. Units can be `nanos`, `micros`, `ms` (milliseconds), `s` (seconds), `m` (minutes), `h` (hours) and
    /// `d` (days). Also accepts "0" without a unit and "-1" to indicate an unspecified value.
    #[serde(
        rename = "suggest_time",
    ...
    #[serde(
        rename = "concurrent_query_time_in_millis",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub concurrent_query_time_in_millis: Option<String>,
    ...
    #[serde(
        rename = "point_in_time_time_in_millis",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub point_in_time_time_in_millis: Option<String>,
    /// The total number of shard query operations.
    #[serde(rename = "query_total")]
    pub query_total: u32,
    /// The number of currently open shard PIT contexts.
    #[serde(
        rename = "point_in_time_current",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub point_in_time_current: Option<u32>,
    /// A duration. Units can be `nanos`, `micros`, `ms` (milliseconds), `s` (seconds), `m` (minutes), `h` (hours) and
    /// `d` (days). Also accepts "0" without a unit and "-1" to indicate an unspecified value.
    #[serde(
        rename = "concurrent_query_time",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub concurrent_query_time: Option<String>,
    /// A duration. Units can be `nanos`, `micros`, `ms` (milliseconds), `s` (seconds), `m` (minutes), `h` (hours) and
    /// `d` (days). Also accepts "0" without a unit and "-1" to indicate an unspecified value.
    #[serde(
        rename = "scroll_time",
...
impl SearchStats {
    pub fn new(
        fetch_current: u32,
        suggest_current: u32,
        scroll_time_in_millis: String,
        fetch_total: u32,
        query_time_in_millis: String,
        query_current: u32,
        fetch_time_in_millis: String,
        scroll_current: u32,
        suggest_time_in_millis: String,
        suggest_total: u32,
        query_total: u32,
        scroll_total: u32,
    ) -> SearchStats {
