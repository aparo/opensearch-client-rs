...
/// `regexp` query, see [Regular expression syntax](https://www.elastic.co/guide/en/opensearch/reference/current/regexp-syntax.html).
///
...
impl Query {
  ...
  /// [Regular expression syntax](https://www.elastic.co/guide/en/opensearch/reference/current/regexp-syntax.html). <br/>
  ///
  /// By default, regular expressions are limited to 1,000 characters. You can
  /// change this limit using the
  /// [`index.max_regex_length`](https://www.elastic.co/guide/en/opensearch/reference/current/index-modules.html#index-max-regex-length) setting.
...
impl RegexpQuery {
  ...
  /// [Regular expression syntax](https://www.elastic.co/guide/en/opensearch/reference/current/regexp-syntax.html#regexp-optional-operators).
  ...
  /// indexed field values when set to `true`. Default is `false` which means
  ...
  ///
  /// OpenSearch uses [Apache Lucene](https://lucene.apache.org/core/) internally to parse
  ...
  /// see the [rewrite](Rewrite) parameter.
