...
/// [`bool` query](crate::BoolQuery) from the terms. Each term except the last
/// is used in a [`term` query](crate::TermQuery). The last term is used in a
...
///   .name("test");
/// ```
/// <https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-match-bool-prefix-query.html>
