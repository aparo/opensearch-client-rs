...
pub struct FollowerStatus {
    ...
    #[serde(
        rename = "num_paused_indices",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub num_paused_indices: Option<f64>,
    #[serde(
        rename = "num_syncing_indices",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub num_syncing_indices: Option<f64>,
    #[serde(
        rename = "operations_written",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "num_index_tasks",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub num_index_tasks: Option<f64>,
    #[serde(
        rename = "throttled_write_requests",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub throttled_write_requests: Option<f64>,
    #[serde(
        rename = "num_failed_indices",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub num_failed_indices: Option<f64>,
    #[serde(
        rename = "failed_read_requests",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub failed_read_requests: Option<f64>,
    #[serde(
        rename = "num_shard_tasks",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub num_shard_tasks: Option<f64>,
