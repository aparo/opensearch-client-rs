...
///   .name("test");
/// ```
/// <https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-simple-query-string-query.html>
...
impl SimpleQueryStringQuery {
  ...
  /// See
  /// [Wildcards and per-field boosts in the fields parameter](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-simple-query-string-query.html#simple-query-string-boost)
  /// for examples.
  ///
