...
pub struct TermvectorsRequestBodyJson {
    ...
    pub per_field_analyzer: Option<serde_json::Value>,  /// An artificial document (a document not present in the index) for which you want to retrieve term vectors.
    #[serde(rename = "doc", default, skip_serializing_if = "Option::is_none")]
    pub doc: Option<serde_json::Value>,
}

impl TermvectorsRequestBodyJson {
      /// Define parameters and or supply a document to get termvectors for. See documentation.
    pub fn new() -> TermvectorsRequestBodyJson {
        TermvectorsRequestBodyJson {
            filter: None,
