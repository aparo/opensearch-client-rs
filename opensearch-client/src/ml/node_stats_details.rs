...
pub struct NodeStatsDetails {
    ...
    pub algorithms: Option<ml::Algorithms>,
    /// The JVM heap usage.
    #[serde(
        rename = "ml_jvm_heap_usage",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "ml_deployed_model_count",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "ml_circuit_breaker_trigger_count",
        default,
        skip_serializing_if = "Option::is_none"
    )]
