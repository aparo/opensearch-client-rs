...
pub struct Operation {
    #[serde(rename = "_id")]
    pub id: String,
    /// When `true`, the response includes the document count, the sum of the document frequencies, and the sum of the term frequencies.
    #[serde(
        rename = "field_statistics",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub field_statistics: Option<bool>,
    ...
    /// When `true`, the response includes the term frequency and the document frequency.
    #[serde(
        rename = "term_statistics",
        default,
        skip_serializing_if = "Option::is_none"
    )]
