...
//! [script evaluation](https://www.elastic.co/guide/en/opensearch/reference/current/modules-scripting.html)
//! (based on different fields) for each hit.
//!
//! <https://www.elastic.co/guide/en/opensearch/reference/current/search-fields.html#script-fields>
...
mod tests {
  ...
  fn serializes_correctly() {
    let subject = Search::new()
      .script_fields("test1", Script::source("doc['price'].value * 2").lang("painless"))
      .script_fields(
        "test2",
