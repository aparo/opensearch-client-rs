...
impl SimulateIndexTemplateRequestBodyJson {
    /// New index template definition, which will be included in the simulation, as if it already exists in the system
    pub fn new() -> SimulateIndexTemplateRequestBodyJson {
        SimulateIndexTemplateRequestBodyJson {
            priority: None,
            composed_of: None,
            version: None,
