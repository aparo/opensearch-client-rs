...
/// The completion suggester considers all documents in the index, but it is
/// often desirable to serve suggestions filtered and/or boosted by some
/// criteria. For example, you want to suggest song titles filtered by certain
/// artists or you want to boost song titles based on their genre.
///
/// To achieve suggestion filtering and/or boosting, you can add context
/// mappings while configuring a completion field. You can define multiple
