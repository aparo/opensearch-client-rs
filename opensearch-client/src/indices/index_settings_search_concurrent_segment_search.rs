...
pub struct IndexSettingsSearchConcurrentSegmentSearch {
...
impl IndexSettingsSearchConcurrentSegmentSearch {
    pub fn new() -> IndexSettingsSearchConcurrentSegmentSearch {
