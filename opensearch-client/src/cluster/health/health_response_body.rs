...
pub struct HealthResponseBody {
    #[serde(
        rename = "active_shards_percent",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub active_shards_percent: Option<String>,
    /// True if the cluster-manager node has been discovered.
    #[serde(
        rename = "discovered_master",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub discovered_master: Option<bool>,
    ...
    /// True if the cluster-manager node has been discovered.
    #[serde(
        rename = "discovered_cluster_manager",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub task_max_waiting_in_queue_millis: String,
    /// A duration. Units can be `nanos`, `micros`, `ms` (milliseconds), `s` (seconds), `m` (minutes), `h` (hours) and
    /// `d` (days). Also accepts "0" without a unit and "-1" to indicate an unspecified value.
    #[serde(
        rename = "task_max_waiting_in_queue",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub task_max_waiting_in_queue: Option<String>,
...
impl HealthResponseBody {
    pub fn new(
        ...
        active_shards: u32,
        timed_out: bool,
        task_max_waiting_in_queue_millis: String,
        number_of_nodes: u32,
        cluster_name: String,
