...
pub struct GetStatsResponse {
    ...
    #[serde(
        rename = "ml_controller_index_status",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "ml_connector_index_status",
        default,
        skip_serializing_if = "Option::is_none"
    )]
