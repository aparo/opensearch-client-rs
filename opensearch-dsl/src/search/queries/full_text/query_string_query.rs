...
///   .name("test");
/// ```
/// <https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-query-string-query.html>
...
impl Query {
  ...
  /// [Simple query string syntax](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-simple-query-string-query.html#simple-query-string-syntax).
...
impl QueryStringQuery {
  ...
  /// [nested documents](https://www.elastic.co/guide/en/opensearch/reference/current/nested.html).
  ...
  /// [search setting](https://www.elastic.co/guide/en/opensearch/reference/current/search-settings.html),
  ...
  /// [`match_phrase`](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-match-query-phrase.html)
  /// query for each
  /// [multi-position token](https://www.elastic.co/guide/en/opensearch/reference/current/token-graphs.html#token-graphs-multi-position-tokens).
  ///
  /// Defaults to `true`. For examples, see
  /// [Multi-position tokens](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-simple-query-string-query.html#simple-query-string-synonyms).
  pub fn auto_generate_synonyms_phrase_query(mut self, auto_generate_synonyms_phrase_query: bool) -> Self {
  ...
  /// [Search multiple fields](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-query-string-query.html#query-string-multi-field).
  ...
  /// value for a
  /// [numeric](https://www.elastic.co/guide/en/opensearch/reference/current/number.html)
  /// field, are ignored.
  ///
  /// Defaults to `false`.
  ...
  /// Default is `10000`.
  ///
  /// OpenSearch uses [Apache Lucene](https://lucene.apache.org/core/)
  ...
  ///
  /// Defaults to the
  /// [`search_quote_analyzer`](https://www.elastic.co/guide/en/opensearch/reference/current/analyzer.html#search-quote-analyzer)
  ...
  /// matches. See
  /// [Mixing exact search with stemming](https://www.elastic.co/guide/en/opensearch/reference/current/mixing-exact-search-with-stemming.html).
...
deserialize_with_root!("query_string": QueryStringQuery);
