...
impl Search {
  ...
  /// [Query DSL](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl.html).
  ...
  /// parameter to specify a duration you’d like to wait on each shard to
  /// complete.
  ///
