...
pub struct ModelProfile {
    ...
    #[serde(
        rename = "memory_size_estimation_cpu",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub worker_nodes: Option<Vec<common::NodeIds>>,
    /// The estimated memory size in GPU.
    #[serde(
        rename = "memory_size_estimation_gpu",
        default,
        skip_serializing_if = "Option::is_none"
    )]
