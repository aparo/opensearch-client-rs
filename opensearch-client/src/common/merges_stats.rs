...
pub struct MergesStats {
    ...
    #[serde(
        rename = "unreferenced_file_cleanups_performed",
        default,
        skip_serializing_if = "Option::is_none"
    )]
...
impl MergesStats {
    pub fn new(
        ...
        current_docs: u32,
        total: u32,
        total_stopped_time_in_millis: String,
        total_throttled_time_in_millis: String,
        total_size_in_bytes: u32,
        total_time_in_millis: String,
        current: u32,
        current_size_in_bytes: u32,
        total_auto_throttle_in_bytes: u32,
    ) -> MergesStats {
        MergesStats {
