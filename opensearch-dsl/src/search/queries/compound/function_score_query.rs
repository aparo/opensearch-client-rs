...
///
/// This can be useful if, for example, a score function is computationally
/// expensive and it is sufficient to compute the score on a filtered set of
/// documents.
///
...
///   .name("test");
/// ```
/// <https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-function-score-query.html>
