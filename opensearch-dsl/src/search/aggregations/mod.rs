...
//!
//! OpenSearch organizes aggregations into three categories:
//!
//! - [Metrics](https://www.elastic.co/guide/en/opensearch/reference/current/search-aggregations-metrics.html)
//!   aggregations that calculate metrics, such as a sum or average, from field
//!   values.
//! - [Bucket](https://www.elastic.co/guide/en/opensearch/reference/current/search-aggregations-bucket.html)
//!   aggregations that group documents into buckets, also called bins, based on
//!   field values, ranges, or other criteria.
//! - [Pipeline](https://www.elastic.co/guide/en/opensearch/reference/current/search-aggregations-pipeline.html)
//!   aggregations that take input from other aggregations instead of documents
//!   or fields.
