...
///   .name("test");
/// ```
/// <https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-multi-match-query.html>
...
impl Query {
  ...
  /// [analyzes](https://www.elastic.co/guide/en/opensearch/reference/current/analysis.html)
  /// any provided text before performing a search. This means the `match`
  /// query can search
  /// [`text`](https://www.elastic.co/guide/en/opensearch/reference/current/text.html)
...
impl MultiMatchQuery {
  ...
  /// documents that contain the same term in multiple fields than documents
  /// that contain this term in only the best of those multiple fields,
  /// without confusing this with the better case of two different terms in
  /// the multiple fields.
  ///
  ...
  /// 2. Multiply the score from any other matching clauses by the tie_breaker
  ///    value.
  ...
  /// If `true`,
  /// [match phrase](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-match-query-phrase.html)
  /// queries are automatically created for multi-term synonyms. Defaults to
  /// `true`.
  ///
  /// See [Use synonyms with match query](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-match-query.html#query-dsl-match-query-synonyms)
  /// for an example.
  ...
  /// [Fuzziness in the match query](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-match-query.html#query-dsl-match-query-fuzziness)
  /// for an example.
...
deserialize_with_root!("multi_match": MultiMatchQuery);
