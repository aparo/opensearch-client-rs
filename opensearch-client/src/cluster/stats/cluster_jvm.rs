...
impl ClusterJvm {
    pub fn new(
        max_uptime_in_millis: String,
        versions: Vec<cluster::stats::ClusterJvmVersion>,
        mem: cluster::stats::ClusterJvmMemory,
        threads: u32,
    ) -> ClusterJvm {
        ClusterJvm {
            max_uptime: None,
