...
/// location. You can also use the query in a [bool](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-bool-query.html)
/// search’s `should` filter to add boosted relevance scores to the `bool`
/// query’s scores.
///
...
/// `origin` value and a document's field values. It then uses this distance as
/// a feature to boost the
...
///
/// Unlike the
/// [`function_score`](https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-function-score-query.html)
/// query or other ways to change
/// [relevance scores](https://www.elastic.co/guide/en/opensearch/reference/current/query-filter-context.html#relevance-scores)
/// , the `distance_feature` query efficiently skips non-competitive hits when
/// the [`track_total_hits`](https://www.elastic.co/guide/en/opensearch/reference/current/search-uri-request.html)
/// parameter is **not** `true`.
///
/// To create distance feature query date query:
/// ```
/// # use opensearch_dsl::Time;
...
/// ```
/// # use opensearch_dsl::{Distance, GeoLocation};
/// # use opensearch_dsl::queries::*;
/// # use opensearch_dsl::queries::params::*;
/// # let query =
/// Query::distance_feature(
///   "test",
///   GeoLocation::new(-71.34, 40.12),
...
/// ```
///
/// <https://www.elastic.co/guide/en/opensearch/reference/current/query-dsl-distance-feature-query.html>
