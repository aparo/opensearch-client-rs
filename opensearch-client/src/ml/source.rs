...
pub struct Source {
    ...
    pub actions: Option<Vec<ml::Action>>,
    ...
    pub current_worker_node_count: Option<f64>,
    /// The chunk number.
    #[serde(
        rename = "chunk_number",
        default,
    ...
    /// The model task type.
    #[serde(
        rename = "model_task_type",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub model_task_type: Option<String>,
    /// The status.
    ...
    #[serde(
        rename = "last_deployed_time",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub last_deployed_time: Option<u32>,
    /// The connector ID.
    #[serde(
        rename = "connector_id",
        default,
    ...
    pub planning_worker_node_count: Option<f64>,
    ...
    pub tools: Option<Vec<ml::ToolItems>>,
    /// The model URL.
    ...
    pub planning_worker_nodes: Option<Vec<common::NodeIds>>,
    /// The model state.
    #[serde(
        rename = "model_state",
        default,
