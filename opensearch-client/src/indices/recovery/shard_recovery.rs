...
pub struct ShardRecovery {
    ...
    #[serde(
        rename = "stop_time_in_millis",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub stop_time_in_millis: Option<String>,
    ...
    pub verify_index: indices::recovery::VerifyIndex,
    /// A date and time, either as a string whose format depends on the context (defaulting to ISO_8601) or the
    /// number of milliseconds since the epoch. OpenSearch accepts both as an input but will generally output a string.
    /// representation.
    #[serde(
...
impl ShardRecovery {
    pub fn new(
        r#type: String,
        translog: indices::recovery::TranslogStatus,
        target: indices::recovery::RecoveryOrigin,
        source: indices::recovery::RecoveryOrigin,
        stage: String,
        total_time_in_millis: String,
        id: u32,
        verify_index: indices::recovery::VerifyIndex,
        primary: bool,
        index: indices::recovery::RecoveryIndexStatus,
