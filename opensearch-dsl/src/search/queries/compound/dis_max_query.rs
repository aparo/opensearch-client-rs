...
/// different [boost](https://www.elastic.co/guide/en/opensearch/reference/current/mapping-boost.html)
/// factors.
///
...
impl DisMaxQuery {
  ...
  /// multiple queries, OpenSearch uses the highest
  /// [relevance score](https://www.elastic.co/guide/en/opensearch/reference/current/query-filter-context.html)
