...
pub struct IndexSettingsAnalyze {
    ...
    #[serde(
        rename = "max_token_count",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub max_token_count: Option<common::StringifiedInteger>,
}

impl IndexSettingsAnalyze {
    pub fn new() -> IndexSettingsAnalyze {
