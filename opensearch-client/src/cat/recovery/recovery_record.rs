...
pub struct RecoveryRecord {
    ...
    #[serde(
        rename = "files_percent",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub files_percent: Option<String>,
    ...
    #[serde(
        rename = "start_time_millis",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub start_time_millis: Option<common::StringifiedEpochTimeUnitMillis>,
    /// A date and time, either as a string whose format depends on the context (defaulting to ISO_8601) or the
    /// number of milliseconds since the epoch. OpenSearch accepts both as an input but will generally output a string.
    /// representation.
    ...
    /// The files recovered.
    #[serde(
        rename = "files_recovered",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub files_recovered: Option<String>,
    /// The shard name.
    ...
    /// strings to the target type.
    #[serde(
        rename = "stop_time_millis",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub stop_time_millis: Option<common::StringifiedEpochTimeUnitMillis>,
    /// The target host.
    #[serde(
        rename = "target_host",
        default,
    ...
    /// The bytes recovered.
    #[serde(
        rename = "bytes_recovered",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub bytes_recovered: Option<String>,
    ...
    pub translog_ops: Option<String>,
    ...
    #[serde(
        rename = "translog_ops_recovered",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub translog_ops_recovered: Option<String>,
    ...
    #[serde(
        rename = "translog_ops_percent",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub translog_ops_percent: Option<String>,
    #[serde(
        rename = "bytes_percent",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub bytes_percent: Option<String>,
    /// The recovery type.
