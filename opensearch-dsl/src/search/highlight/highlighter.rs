...
/// reflect the query matching logic in terms of understanding word importance
/// and any word positioning criteria in phrase queries.
///
/// > **Warning**<br/>
...
/// highlighter breaks the text into sentences and uses the BM25 algorithm to
/// score individual sentences as if they were documents in the corpus. It also
/// supports accurate phrase and multi-term (fuzzy, prefix, regex) highlighting.
