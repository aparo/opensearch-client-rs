...
/// query. You can create parent-child relationships between documents in the
/// same index using a join field mapping.
///
...
impl HasChildQuery {
  ...
  ///
  /// If `false`, OpenSearch returns an error if the `type` is unmapped.
  ///
