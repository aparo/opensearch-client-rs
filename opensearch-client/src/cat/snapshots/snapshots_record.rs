...
pub struct SnapshotsRecord {
    ...
    pub start_epoch: Option<common::StringifiedEpochTimeUnitSeconds>,
    /// The number of successful shards in the snapshot.
    #[serde(
        rename = "successful_shards",
        default,
        skip_serializing_if = "Option::is_none"
    )]
    pub successful_shards: Option<String>,
